...
__C.coarse.model_name = '/shenlab/lab_stor6/qinliu/CT_Pancreas/model/model_0921_2020/coarse'
...
__C.coarse.partition_size = [102.4, 102.4, 102.4]
...
__C.coarse.partition_stride = [102.4, 102.4, 102.4]
