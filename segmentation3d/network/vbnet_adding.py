...
class SegmentationNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.up_256 = UpBlock(256, 128, 3, compression=True)
        self.up_128 = UpBlock(128, 64, 3, compression=True)
        self.up_64 = UpBlock(64, 32, 2, compression=False)
        self.up_32 = UpBlock(32, 16, 1, compression=False)
