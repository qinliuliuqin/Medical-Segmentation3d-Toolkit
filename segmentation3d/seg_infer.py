...
def main():
    ...
    default_model = '/shenlab/lab_stor6/qinliu/CT_Pancreas/model/model_0921_2020/'
    ...
    default_output = '/shenlab/lab_stor6/qinliu/CT_Pancreas/results/model_0921_2020/contrast_7'
